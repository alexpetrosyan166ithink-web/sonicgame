...
// Sonic SVG will be loaded from file
const sonicSvgLoaded = { texture: null };
function loadSonicSvg() {
    const img = new Image();
    img.onload = function() {
        const canvas = document.createElement('canvas');
        canvas.width = 345;
...
function drawSonicCanvas() {
    ...
    ctx.beginPath();
    ctx.ellipse(45, 55, 20, 25, 0, 0, Math.PI * 2);
    ctx.fillStyle = skin;
    ctx.fill();
    ctx.stroke();
    ...
    // Left eye white
    ctx.beginPath();
    ctx.ellipse(38, 48, 10, 14, -0.2, 0, Math.PI * 2);
    ctx.fillStyle = white;
    ctx.fill();
    ctx.stroke();

    // Right eye white (connected)
    ctx.beginPath();
    ctx.ellipse(52, 48, 10, 14, 0.2, 0, Math.PI * 2);
    ctx.fillStyle = white;
    ctx.fill();
    ctx.stroke();
    ...
    // Left pupil
    ctx.beginPath();
    ctx.ellipse(42, 50, 4, 6, 0, 0, Math.PI * 2);
    ctx.fillStyle = black;
    ctx.fill();

    // Right pupil
    ctx.beginPath();
    ctx.ellipse(54, 50, 4, 6, 0, 0, Math.PI * 2);
    ctx.fillStyle = black;
    ctx.fill();

    // Nose
    ctx.beginPath();
    ctx.ellipse(35, 60, 5, 4, 0, 0, Math.PI * 2);
    ctx.fillStyle = black;
    ctx.fill();

    // Smile
    ctx.beginPath();
    ctx.arc(45, 65, 8, 0.2, Math.PI - 0.2);
    ctx.strokeStyle = black;
    ctx.lineWidth = 2;
    ctx.stroke();
    ...
    // Ear
    ctx.beginPath();
    ctx.ellipse(20, 35, 8, 12, -0.5, 0, Math.PI * 2);
    ctx.fillStyle = blue;
    ctx.fill();
    ctx.strokeStyle = black;
    ctx.stroke();
    ...
    // Inner ear
    ctx.beginPath();
    ctx.ellipse(20, 37, 4, 7, -0.5, 0, Math.PI * 2);
    ctx.fillStyle = skin;
    ctx.fill();

    // Body
    ctx.beginPath();
    ctx.ellipse(55, 100, 20, 25, 0, 0, Math.PI * 2);
    ctx.fillStyle = blue;
    ctx.fill();
    ctx.strokeStyle = black;
    ctx.lineWidth = 2;
    ...
    // Belly
    ctx.beginPath();
    ctx.ellipse(50, 100, 12, 18, 0, 0, Math.PI * 2);
    ctx.fillStyle = skin;
    ctx.fill();
    ctx.stroke();
    ...
    // Left arm
    ctx.beginPath();
    ctx.ellipse(25, 95, 8, 15, -0.8, 0, Math.PI * 2);
    ctx.fillStyle = blue;
    ctx.fill();
    ctx.stroke();
    ...
    // Right arm
    ctx.beginPath();
    ctx.ellipse(80, 90, 8, 15, 0.5, 0, Math.PI * 2);
    ctx.fillStyle = blue;
    ctx.fill();
    ctx.stroke();
    ...
    // Left leg
    ctx.beginPath();
    ctx.ellipse(40, 130, 8, 15, -0.2, 0, Math.PI * 2);
    ctx.fillStyle = blue;
    ctx.fill();
    ctx.stroke();
    ...
    // Left shoe
    ctx.beginPath();
    ctx.ellipse(35, 150, 15, 10, 0, 0, Math.PI * 2);
    ctx.fillStyle = red;
    ctx.fill();
    ctx.stroke();
    ...
    // Right leg
    ctx.beginPath();
    ctx.ellipse(65, 130, 8, 15, 0.2, 0, Math.PI * 2);
    ctx.fillStyle = blue;
    ctx.fill();
    ctx.strokeStyle = black;
    ctx.lineWidth = 2;
    ...
    // Right shoe
    ctx.beginPath();
    ctx.ellipse(72, 150, 15, 10, 0, 0, Math.PI * 2);
    ctx.fillStyle = red;
    ctx.fill();
    ctx.stroke();
...
function createEnhancedSonic() {
    ...
    // Load Sonic directly from sonic.svg file
    const img = new Image();
    img.onload = function() {
        const canvas = document.createElement('canvas');
        canvas.width = 345;
